...
@Component({
    selector: 'kjf-observable',
    templateUrl: './kjf-observable.component.html',
    styleUrls: ['./kjf-observable.component.scss'],
})
export class KjfObservableComponent implements OnInit {
